...
def main():
    ...
    for fold in os.listdir(directorio_principal):
        ruta_carpeta = os.path.join(directorio_principal, fold)
        ...
        if os.path.isdir(ruta_carpeta):
            for paciente in os.listdir(ruta_carpeta):
                ruta_paciente = os.path.join(ruta_carpeta, paciente)
        ...
        resultados_totales_path = os.path.join(ruta_carpeta, 'resultados_totales.xlsx')
        ...
        ruta_guardar = os.path.join(ruta_carpeta, 'promedios_metricas_dosis_predicciones.xlsx')
        ...
        ruta_guardado = os.path.join(ruta_carpeta, 'promedios_rmse_dvh.xlsx')
